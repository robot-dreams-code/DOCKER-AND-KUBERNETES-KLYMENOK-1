...
[+] Building 9.5s (11/11) FINISHED                                                                                                                                                           docker:rancher-desktop
 ...
 => [internal] load metadata for docker.io/library/python:3.14-alpine3.22                                                                                                                                      0.2s
 ...
 => [4/6] RUN pip install -r requirements.txt                                                                                                                                                                  7.2s
 => [5/6] COPY . .                                                                                                                                                                                             0.1s
 => [6/6] RUN adduser -D -u 1000 appuser      && chown -R appuser:appuser /app      &&  apk update && apk add curl                                                                                             1.8s
 => exporting to image                                                                                                                                                                                         0.2s
 => => exporting layers                                                                                                                                                                                        0.2s
 => => writing image sha256:3d001c156752929dee67069967febb2c33581a09cbb2172da950224262706455                                                                                                                   0.0s
...
bd07960bec5e   lesson-04:1.0.0   "uvicorn src.main:ap…"   2 minutes ago   Up 2 minutes (healthy)   0.0.0.0:8080->8080/tcp, [::]:8080->8080/tcp   lesson-05-app-1
