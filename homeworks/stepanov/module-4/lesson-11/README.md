...
який використовувався в попередніх завданнях?
...
```
Як я зрозумів, то депенденці апдейт тільки та депенденці в Chart.yaml працює. Інша команда не апгрейдила існуючий редіс под.
...
Є якийсь інший спосіб змушувати поди перестворюватися зі змінами?
